...
export const es: Translations = {
  header: {
    ...
    language: "ES",
    supportTooltip: "Soporte de marketing",
  ...
  cta: {
    ...
    subtitle: "Explora nuestras aplicaciones especializadas para necesidades específicas del sector público.",
    tenderswin_title: "TENDERSWIN.AI",
    tenderswin_description: "Plataforma especializada en licitaciones públicas y concursos gubernamentales.",
    govsupply_title: "GOVSUPPLY.AI",
    govsupply_description: "Soluciones inteligentes para proveedores del sector público y contratación estatal.",
    acceleralia_title: "ACCELERALIA",
    acceleralia_description: "Solución integral e innovadora para gestionar el talento y ejecutar proyectos.",
    grantswin_title: "GRANTSWIN.AI",
    grantswin_description: "La suite que simplifica el acceso a la financiación pública con IA."
  },
  footer: {
    copyright: "© 2026 Redes Comerciales.Sales. Todos los derechos reservados.",
    version: "v.1.2",
  ...
  webinarModal: {
    title: "Webinars",
    subtitle: "Accede a nuestras herramientas especializadas para la gestión de tus eventos virtuales.",
    generatorTitle: "Generador de Webinars",
    managerTitle: "Gestión de Asistentes",
    accessButton: "Acceder"
  },
  automationModal: {
    title: "Automatizaciones",
    subtitle: "Potencia tu productividad conectando tus herramientas favoritas.",
  ...
  login: {
    ...
    welcomeSubtitle: "Ingresa tus credenciales para acceder a Redes Comerciales.Sales",
    emailLabel: "Correo electrónico",
    emailPlaceholder: "tu@correo.com",
    ...
    errorInvalidLogin: "Correo o contraseña incorrectos."
  }
};
